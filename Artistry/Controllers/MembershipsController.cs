...
namespace Artistry.Controllers
{
    public class MembershipsController : Controller
    {
        ...
        public MembershipsController(ArtistryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Price")] Membership membership)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Price")] Membership membership)
        {
            if (id != membership.Id)
            {
                return NotFound();
